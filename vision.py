...
def filterImageTape(input):
    ...
    return cv.inRange(input, np.array([175,175,175]), np.array([255,255,255]), input) #white light BGR
    #return cv.inRange(input, np.array([100,200,0]), np.array([255,255,100]), input) #green light BGR
    #img1 = cv.inRange(input, np.array([0, 0, 200]), np.array([100, 255, 255]), input) #white light HSV
    #img2 = cv.inRange(input, np.array([150, 0, 200]), np.array([255, 255, 255]), input) #white light HSV
    #return cv.bitwise_or(img1, img2) #white light HSV
